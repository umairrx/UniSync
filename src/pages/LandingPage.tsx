...
const FEATURES = [
  ...
  },
  {
    ...
    description:
      "Never double-book yourself again. Real-time warnings when courses overlap or conflict.",
  ...
  },
  {
    ...
    description:
      "Add, edit, and organize your courses with all critical details like sections, credits, and locations.",
  ...
  },
  {
    ...
    description:
      "Automatically track your total credits as you build your schedule. Stay within limits effortlessly.",
  ...
  },
  {
    ...
    description:
      "Color-coded blocks and clear layouts make your schedule easy to read at a glance.",
...
const STEPS = [
  {
    ...
    description:
      "Enter your course details including name, code, section, credits, and preferred times.",
  },
  {
    step: "02",
  ...
  },
  {
    ...
    description:
      "Adjust colors, resolve conflicts, and fine-tune your schedule until it's perfect.",
  },
  {
    step: "04",
    icon: Share2,
...
const FAQS = [
  {
    ...
    answer:
      "Yes! UniSync is completely free and open-source. There are no hidden fees, premium tiers, or paywalls. We believe every student deserves access to quality scheduling tools.",
  },
  {
    question: "Do I need to create an account?",
    answer:
      "No account required! Your timetable data is stored locally in your browser. You can start scheduling immediately without any sign-up process.",
  },
  {
    question: "Can I use UniSync on my phone?",
    answer:
      "UniSync is built with a responsive design that works on tablets and mobile devices. However, for the best experience with drag-and-drop, we recommend using a desktop or laptop.",
  },
  {
    question: "How do I export my timetable?",
    answer:
      "Simply click the 'Export' button in the timetable view. You can download your schedule as a high-quality PNG image that's perfect for printing or sharing.",
  },
  {
    question: "Is my data secure?",
    answer:
      "Your data never leaves your device. Everything is stored locally in your browser's storage. We don't collect, track, or store any personal information on our servers.",
  },
  {
    question: "Can I contribute to UniSync?",
    answer:
      "Absolutely! UniSync is open-source and we welcome contributions. Check out our GitHub repository to report issues, suggest features, or submit pull requests.",
  },
] as const;
...
const TESTIMONIALS = [
  {
    quote:
      "UniSync saved me hours of planning. The drag-and-drop interface is incredibly intuitive!",
    author: "Alex Chen",
  ...
  {
    quote:
      "Finally, a timetable tool that just works. No sign-ups, no ads, just pure functionality.",
    author: "Sarah Miller",
        ...
        <header className="border-b bg-background/80 backdrop-blur-xl fixed top-0 w-full z-50">
          <div className="container mx-auto px-4 py-3 sm:py-4 flex items-center justify-between">
            <div className="flex items-center gap-2 sm:gap-3">
              <img
                src={
                  resolvedTheme === "dark" ? "/unisync-full-white.svg" : "/unisync-full-dark.svg"
                }
                alt="UniSync Logo"
        ...
        <main className="flex-1 pt-16 sm:pt-20">
          <section className="relative pt-10 sm:pt-16 pb-20 sm:pb-28 lg:pb-36 px-4 overflow-hidden">
            <div className="absolute inset-0 -z-10" aria-hidden="true">
              <div className="absolute inset-0 bg-linear-to-br from-primary/8 via-background to-secondary/12" />
              <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-[800px] bg-linear-to-br from-primary/20 via-transparent to-transparent rounded-full blur-3xl opacity-60" />
              <div className="absolute bottom-0 right-0 w-[600px] h-[600px] bg-linear-to-r from-secondary/25 via-transparent to-transparent rounded-full blur-3xl opacity-50" />
              <div className="absolute top-1/2 left-0 w-[400px] h-[400px] bg-linear-to-r from-accent/20 via-transparent to-transparent rounded-full blur-3xl opacity-40" />
            </div>
            ...
            <div className="container mx-auto max-w-5xl text-center relative">
              ...
              <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-black tracking-tight leading-[1.1] mb-6 animate-in fade-in slide-in-from-bottom-6 duration-700 delay-100">
                ...
                <span className="relative inline-block">
                  <span className="relative z-10 bg-linear-to-r from-primary via-primary to-amber-500 bg-clip-text text-transparent">
                    University Schedule
                  </span>
                  <span
                    className="absolute bottom-1 sm:bottom-2 left-1/2 -translate-x-1/2 w-[90%] sm:w-full h-1.5 sm:h-3 bg-primary/20 -rotate-1 rounded-sm z-0"
                    aria-hidden="true"
                  />
                </span>
              </h1>
              ...
              <p className="text-lg sm:text-xl md:text-2xl text-muted-foreground max-w-3xl mx-auto leading-relaxed mb-10 animate-in fade-in slide-in-from-bottom-8 duration-700 delay-200">
                The intuitive drag-and-drop timetable builder that helps you create, visualize, and
                export your course schedule in minutes—not hours.
              </p>
            ...
            <div className="container mx-auto max-w-6xl">
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                {FEATURES.map((feature, index) => (
                  <Card
                    key={feature.title}
                    className="group relative overflow-hidden border-0 bg-linear-to-br from-card to-card hover:shadow-xl transition-all duration-500 hover:-translate-y-1"
                ...
                {STEPS.map((step, index) => (
                  <div key={step.title} className="relative group">
                    {index < STEPS.length - 1 && (
                      <div className="hidden lg:block absolute top-12 left-[calc(50%+2rem)] w-[calc(100%-4rem)] h-0.5 bg-linear-to-r from-primary/30 to-primary/10" />
                    )}
            ...
            <div className="container mx-auto max-w-6xl">
              ...
              <div className="grid md:grid-cols-3 gap-6">
                {TESTIMONIALS.map((testimonial, index) => (
                  <Card
                    key={index}
                    className="h-full border-0 bg-linear-to-br from-card to-muted/30 hover:shadow-lg transition-all duration-300"
                  >
                    <CardContent className="p-6 sm:p-8 flex flex-col h-full">
                      ...
                      <blockquote className="text-foreground mb-6 grow italic">
                        "{testimonial.quote}"
                      </blockquote>
          ...
          <section className="py-20 sm:py-28 px-4 bg-muted/30">
            <div className="container mx-auto max-w-4xl">
              <Card className="border-0 bg-linear-to-br from-card via-card to-primary/5 overflow-hidden shadow-xl">
                <CardContent className="p-8 sm:p-12 text-center relative">
                  ...
                  <div className="relative">
                    ...
                    <p className="text-lg text-muted-foreground max-w-2xl mx-auto mb-8">
                      UniSync is proudly open-source. We believe in transparency, community
                      collaboration, and making education tools accessible to all students
          ...
          <section className="py-24 sm:py-32 px-4 relative overflow-hidden">
            <div className="absolute inset-0 -z-10" aria-hidden="true">
              <div className="absolute top-1/4 -left-20 w-80 h-80 bg-linear-to-br from-primary/30 to-amber-500/20 rounded-full blur-3xl animate-pulse" />
              <div
                className="absolute bottom-1/4 -right-20 w-96 h-96 bg-linear-to-r from-orange-500/20 to-primary/30 rounded-full blur-3xl animate-pulse"
            ...
            <div className="container mx-auto max-w-5xl">
              <div className="relative">
                <div className="relative backdrop-blur-xl bg-card/40 dark:bg-card/20 border border-white/10 dark:border-white/5 rounded-3xl p-8 sm:p-12 lg:p-16 shadow-2xl overflow-hidden">
                  <div className="absolute inset-0 bg-linear-to-br from-primary/5 via-transparent to-orange-500/5 rounded-3xl" />

                  <div className="absolute top-0 right-0 w-32 h-32 bg-linear-to-bl from-primary/20 to-transparent rounded-bl-[100px]" />
                  ...
                  <div className="relative z-10 grid lg:grid-cols-5 gap-10 lg:gap-16 items-center">
                    <div className="lg:col-span-3 space-y-6">
                      ...
                      <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold tracking-tight leading-[1.1]">
                        Have Questions or
                        <span className="block bg-linear-to-r from-primary via-amber-500 to-orange-500 bg-clip-text text-transparent">
                          Feedback?
                        </span>
                      </h2>

                      <p className="text-lg text-muted-foreground leading-relaxed max-w-xl">
                        We'd love to hear from you! Whether you have suggestions, found a bug, or
                    ...
                    <div className="lg:col-span-2">
                      <a
                        ...
                        className="group relative block p-6 sm:p-8 rounded-2xl bg-linear-to-br from-primary/10 via-primary/5 to-orange-500/10 border border-primary/20 hover:border-primary/40 transition-all duration-500 hover:shadow-xl hover:shadow-primary/10 hover:-translate-y-1"
                      >
                        <div className="absolute inset-0 rounded-2xl bg-linear-to-r from-transparent via-white/10 to-transparent opacity-0 group-hover:opacity-100 group-hover:animate-shimmer transition-opacity duration-500" />
                        ...
                        <div className="relative z-10 flex flex-col items-center text-center space-y-4">
                          <div className="relative">
                            ...
                            <div className="relative w-16 h-16 rounded-2xl bg-linear-to-br from-primary to-amber-500 flex items-center justify-center shadow-lg group-hover:scale-110 group-hover:rotate-3 transition-all duration-500">
          ...
          <section className="py-24 sm:py-32 px-4 relative overflow-hidden">
            ...
            <div className="container mx-auto max-w-4xl text-center">
              ...
              <p className="text-lg text-muted-foreground max-w-2xl mx-auto mb-10">
                Join students worldwide who are already using UniSync to build their perfect
                schedules. It takes less than a minute to get started.
              </p>
              <Button
                size="lg"
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12">
              ...
              <div>
                ...
                <ul className="space-y-2 text-sm text-muted-foreground">
                  <li>
                    <Link to="/table" className="hover:text-foreground transition-colors">
                      Get Started
                    </Link>
                  </li>
                  <li>
              ...
              <div>
                ...
                <ul className="space-y-2 text-sm text-muted-foreground">
                  ...
                  <li>
                    <a
                      href="https://github.com/umairrx/UniSync/blob/main/LICENSE"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="hover:text-foreground transition-colors"
                    >
